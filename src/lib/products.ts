...
export const PRODUCTS: Product[] = [
  ...
  {
    id: 'accessory-001',
    name: 'Dingersville Golf Balls',
    tagline: 'Six-pack of game-ready balls',
    description: 'Top-quality Surlyn golf balls — six-pack with cohesive design. Perfect for team outings, corporate events, or casual play. Sleek, professional appearance.',
    priceCents: 2200,
    currency: 'usd',
    color: 'Multi',
    sizes: ['One Size'],
    image: byPrintifyId('68450b52abde4a754e0c6fcb')!.image,
    category: 'accessories',
    printifyId: '68450b52abde4a754e0c6fcb',
    printifyVariantId: byPrintifyId('68450b52abde4a754e0c6fcb')!.printifyVariantId,
    sku: byPrintifyId('68450b52abde4a754e0c6fcb')!.sku,
    costCents: byPrintifyId('68450b52abde4a754e0c6fcb')!.costCents,
  },
  {
    id: 'accessory-002',
    name: 'Golf Towel',
